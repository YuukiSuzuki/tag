...
int main(){
	...
	for ( auto contour=contours.begin();contour!=contours.end(); contour++){
		...
		if(approxcurve.size()==4 /*&& area > 1000 && cv::isContourConvex(approxcurve)*/){ //頂点が４つの場合と面積が1000以上の場合　//凸型の場合
			...
			//MPSのinput側の
			if(id_nunber[count].id==1 || id_nunber[count].id==17 || id_nunber[count].id==33 || id_nunber[count].id==81 || id_nunber[count].id==97 || id_nunber[count].id==113 || id_nunber[count].id==129 || id_nunber[count].id==145 || id_nunber[count].id==161 || id_nunber[count].id==177 || id_nunber[count].id==193 ||id_nunber[count].id==65 || id_nunber[count].id==49 || id_nunber[count].id==209){
			cv::projectPoints(AsrcPoints3D,rotation,translation,intrinsic,distortion,BdstPoints2D);
			}
                        //MPSのoutput側
			if(id_nunber[count].id==2 || id_nunber[count].id==18 || id_nunber[count].id==34 || id_nunber[count].id==82 || id_nunber[count].id==98 || id_nunber[count].id==114 || id_nunber[count].id==130 || id_nunber[count].id==146 || id_nunber[count].id==162 || id_nunber[count].id==178 || id_nunber[count].id==194 || id_nunber[count].id==66 || id_nunber[count].id==50 || id_nunber[count].id==210 ){
       ...
       //カメラ座標系に変換
        for(int i=0; i<14 ; i++){
		   ...
		   //x
                   ...
                   //MPSのinput側の
		   if(id_nunber[i].id==1 || id_nunber[i].id==17 || id_nunber[i].id==33 || id_nunber[i].id==81 || id_nunber[i].id==97 || id_nunber[i].id==113 || id_nunber[i].id==129 || id_nunber[i].id==145 || id_nunber[i].id==161 || id_nunber[i].id==177 || id_nunber[i].id==193 ||id_nunber[i].id==65 || id_nunber[i].id==49 || id_nunber[i].id==209){
                   matX=matA*matB;
		   ...
		   //MPSのoutput側
                   if(id_nunber[i].id==2 || id_nunber[i].id==18 || id_nunber[i].id==34 || id_nunber[i].id==82 || id_nunber[i].id==98 || id_nunber[i].id==114 || id_nunber[i].id==130 || id_nunber[i].id==146 || id_nunber[i].id==162 || id_nunber[i].id==178 || id_nunber[i].id==194 || id_nunber[i].id==66 || id_nunber[i].id==50 || id_nunber[i].id==210 ){
                   matX=matA*matC;
       ...
       for(int i=0; i<14 ; i++){
                if(id_nunber[i].id!=0){
			cv::Mat matA(4,4,CV_64F,id_nunber[i].f);
