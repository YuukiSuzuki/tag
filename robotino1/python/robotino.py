...
if __name__ == '__main__':
  ...
  rospy.init_node('robotino1')
  rospy.Subscriber('robotino1/velocity', Float32MultiArray, setVelocity)
  rospy.Subscriber('robotino1/positionDriver', Pose, setPosition)
  rospy.Subscriber('robotino1/setOdometry', Pose, setOdometry)
  # pub01 = rospy.Publisher('odometry', Float32MultiArray, queue_size = 10)
  pub01 = rospy.Publisher('robotino1/odometry', Pose, queue_size = 10)
  pub02 = rospy.Publisher('robotino1/checkFlag', Bool, queue_size = 10)
  pub03 = rospy.Publisher('robotino1/getVelocity', Float32MultiArray, queue_size = 10)
  rate = rospy.Rate(10)
