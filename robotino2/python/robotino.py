...
if __name__ == '__main__':
  ...
  rospy.init_node('robotino2')
  rospy.Subscriber('robotino2/velocity', Float32MultiArray, setVelocity)
  rospy.Subscriber('robotino2/positionDriver', Pose, setPosition)
  rospy.Subscriber('robotino2/setOdometry', Pose, setOdometry)
  # pub01 = rospy.Publisher('odometry', Float32MultiArray, queue_size = 10)
  pub01 = rospy.Publisher('robotino2/odometry', Pose, queue_size = 10)
  pub02 = rospy.Publisher('robotino2/checkFlag', Bool, queue_size = 10)
  pub03 = rospy.Publisher('robotino2/getVelocity', Float32MultiArray, queue_size = 10)
  rate = rospy.Rate(10)
