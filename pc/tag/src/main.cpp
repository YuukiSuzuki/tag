...
//while(cap.read(frame) && ros::ok()){
	...
	//std::cout << "ID0=" << id_nunber[0].id << std::endl;
	//std::cout << "ID1=" << id_nunber[1].id << std::endl;
	//std::cout << "ID3=" << id_nunber[3].id << std::endl;
	//std::cout << "ID4=" << id_nunber[4].id << std::endl;
	...
	for(int i=0; i<10 ; i++){
		if(id_nunber[i].id!=0){
			//robotino1
			 //std::cout << "合計ID=" << id_nunber[i].id << std::endl;
